...
import com.wipro.velocity.aerocom.exception.ResourceAlreadyExistException;
...
public class UserController {
	...
	//POST -http://localhost:9090/aerocom/api/registerUser
			...
			public Boolean loginUser(@Validated @RequestBody User user) throws
			ResourceNotFoundException
			{
				...
				User u=urepo.findByEmail(email).orElseThrow(() ->
				    new ResourceNotFoundException("Unknown User"));
